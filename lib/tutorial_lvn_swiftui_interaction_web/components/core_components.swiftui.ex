defmodule TutorialLvnSwiftuiInteractionWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `TutorialLvnSwiftuiInteractionWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TutorialLvnSwiftuiInteractionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TutorialLvnSwiftuiInteractionWeb.Gettext, "errors", msg, opts)
    end
  end
