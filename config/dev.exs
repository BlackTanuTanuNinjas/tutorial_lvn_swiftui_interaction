...
config :tutorial_lvn_swiftui_interaction, TutorialLvnSwiftuiInteraction.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "tutorial_lvn_swiftui_interaction_dev",
  stacktrace: true,
...
config :tutorial_lvn_swiftui_interaction, TutorialLvnSwiftuiInteractionWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "QVoNoF6QA0JHqCBHQZKTYY8vURQL+zf61RF79cQXtnsZb1+m4YOaMurIT5vN/S3X",
  watchers: [
    esbuild:
      {Esbuild, :install_and_run,
       [:tutorial_lvn_swiftui_interaction, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:tutorial_lvn_swiftui_interaction, ~w(--watch)]}
  ]
...
config :tutorial_lvn_swiftui_interaction, dev_routes: true
