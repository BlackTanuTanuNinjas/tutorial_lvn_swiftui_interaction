defmodule TutorialLvnSwiftuiInteractionNative do
  @moduledoc """
  ...
  import TutorialLvnSwiftuiInteractionWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {TutorialLvnSwiftuiInteractionWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    gettext_quoted =
      quote do
        import TutorialLvnSwiftuiInteractionWeb.Gettext
      end
    ...
    core_component_module =
      Module.concat([TutorialLvnSwiftuiInteractionWeb, CoreComponents, plugin.module_suffix])
